...
def main(memory_fraction):
    """
    Computes memory_fraction percent of the available virtual memory.
    ...
    required_memory = int(
        psutil.virtual_memory().available / 2**20 * memory_fraction / 100
    )
...
if __name__ == "__main__":
    ...
    parser.add_argument("memory_fraction", type=int)
    main(parser.parse_args().memory_fraction)
